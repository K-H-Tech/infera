...
import (
	...
	userBackofficeInitializer "zarinpal-platform/services/user-backoffice/initializer"
	userDashboardInitializer "zarinpal-platform/services/user-dashboard/initializer"
...
type UserService struct {
	...
	userBackofficeService *userBackofficeInitializer.UserBackofficeService
	userDashboardService  *userDashboardInitializer.UserDashboardService
}
...
func (e *UserService) OnStart(service *core.Service) {
	...
	// Handle Modules
	e.userBackofficeService = userBackofficeInitializer.NewUserBackofficeService(configs, userService)
	e.userBackofficeService.OnStart(service)

	e.userDashboardService = userDashboardInitializer.NewUserDashboardService(configs, userService)
	e.userDashboardService.OnStart(service)
...
func (e *UserService) OnStop() {
	...
	if e.userBackofficeService != nil {
		e.userBackofficeService.OnStop()
	}
	if e.userDashboardService != nil {
		e.userDashboardService.OnStop()
	}
